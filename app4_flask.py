...
# Flask 애플리케이션 설정
app = Flask(__name__)  # 추가된 부분

# 엑셀 파일 및 모델 파일 경로
default_excel_file_path = 'predicted.xlsx'
prediction_excel_file_path = 'prepared.xlsx'
model_dir_path = 'models/ALL_lstm_model.keras'  #통합모델을 이용
